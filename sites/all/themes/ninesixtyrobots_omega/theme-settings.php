...
function ninesixtyrobots_omega_form_system_theme_settings_alter(&$form, $form_state) {
	$form['ninesixtyrobots_omega'] = array(
	'#type' => 'fieldset',
	'#title' => t('960 Robots Settings'),
	);
  $form['ninesixtyrobots_omega']['breadcrumb_delimiter'] = array(
    '#type' => 'textfield',
  ...
  $form['ninesixtyrobots_omega']['use_twitter'] = array(
    '#type' => 'checkbox',
  ...
  $form['ninesixtyrobots_omega']['twitter_search_term'] = array(
    '#type' => 'textfield',
